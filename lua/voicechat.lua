...
local function CreateVoiceVGUI()
	...
	g_VoicePanelList:SetPaintBackground( true )

end

hook.Add( "InitPostEntity", "CreateVoiceVGUI", CreateVoiceVGUI )
hook.Add( "PlayerEndVoice", "PlayerEndVoiceVGUI", PlayerEndVoice )
hook.Add( "PlayerStartVoice", "PlayerStartVoiceVGUI", PlayerStartVoice )
